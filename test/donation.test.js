...
contract("Donation Test", (accounts) => {
    ...
    beforeEach(async () => {
        ...
        await token.approve(donation.address, String(10*1e18), {from: accounts[1]});
        await token.approve(donation.address, String(10*1e18), {from: accounts[2]});
        await token.approve(donation.address, String(10*1e18), {from: accounts[3]});
        await token.approve(donation.address, String(10*1e18), {from: accounts[4]});
    });
